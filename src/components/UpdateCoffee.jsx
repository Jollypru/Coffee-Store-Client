        ...
        <form onSubmit={handleUpdateCoffee}>
            ...
            <div className='md:flex gap-5'>
                ...
                <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group">
                        <input type="text" name="taste" defaultValue={taste} id="" placeholder='Taste' className='input input-bordered w-full' />
                    </label>
                </div>
            </div>
            ...
            <div className='md:flex gap-5'>
                <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group">
                        <input type="text" name="category" defaultValue={category} id="" placeholder='Category' className='input input-bordered w-full' />
                    </label>
                </div>
                <div className="form-control md:w-1/2">
                    <label className='label'>
